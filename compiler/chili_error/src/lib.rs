...
impl SyntaxError {
    ...
    pub fn illegal_fn_call(span: Span) -> Diagnostic<usize> {
        Diagnostic::error()
            ...
            .with_labels(vec![
                Label::primary(span.file_id, span.range().clone()).with_message("not callable")
            ])
    }
    ...
    pub fn unreachable(span: Span) -> Diagnostic<usize> {
        Diagnostic::error()
            ...
            .with_labels(vec![
                Label::primary(span.file_id, span.range().clone()).with_message("unreachable")
            ])
    }
    ...
    pub fn uninit_var(name: String, span: Span) -> Diagnostic<usize> {
        Diagnostic::error()
            ...
            .with_labels(vec![
                Label::primary(span.file_id, span.range().clone()).with_message("not initialized")
            ])
    }
    ...
    pub fn duplicate_symbol(
        ...
        Diagnostic::error()
            ...
            .with_labels(vec![
                Label::primary(duplicate_span.file_id, duplicate_span.range().clone())
    ...
    pub fn outside_of_loop(span: Span, word: &str) -> Diagnostic<usize> {
        ...
        Diagnostic::error()
            .with_message(&msg)
            .with_labels(vec![
                Label::primary(span.file_id, span.range().clone()).with_message(msg)
            ])
    }
