...
pub(crate) fn get_ty_for_builtin_type(symbol: Ustr, tycx: &mut TyCtx) -> Ty {
    match symbol.as_str() {
        ...
        "int" => tycx.new_bound_variable(TyKind::Int(IntTy::Int).create_type()),
        ...
        "uint" => tycx.new_bound_variable(TyKind::UInt(UIntTy::UInt).create_type()),
        ...
        "float" => tycx.new_bound_variable(TyKind::Float(FloatTy::Float).create_type()),
